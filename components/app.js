...
const Contacts = ReactNative.NativeModules.RNUnifiedContacts
...
export default class App extends Component {
  ...
  configureScene(route, routeStack) {
    ...
    if (route.name === 'newChat' || route.name === 'newGroup' || route.name === 'discovery') {
      ...
      return { ...Navigator.SceneConfigs.PushFromRight, defaultTransitionVelocity: 5 }
    } else if (route.name === 'calendar' || route.name === 'notifications' ||
      route.name === 'settings' || route.name === 'starred') {
      return {
        ...Navigator.SceneConfigs.HorizontalSwipeJumpFromRight,
        gestures: {},
        defaultTransitionVelocity: 7
      }
    }
  ...
  renderApp(route, navigator) {
    ...
    else if (route.name === 'newChat') return <List disabled />
